...
import { HomeSection, SearchRequest, Manga, Request, Chapter, ChapterDetails, TagSection, MangaUpdates, RequestManager, PagedResults, Cookie, RequestHeaders, UserForm, SourceMenu } from "..";
...
export declare abstract class Source {
    ...
    */
    ...
    getSourceMenu(): Promise<SourceMenu | null>;
    /**
     * A stateful source may require user input.
     * By supplying this value to the Source, the app will render your form to the user
     * in the application settings.
     */
    getSourceMenuItemForm(itemId: string): Promise<UserForm | null>;
    getSourceMenuItemLink(itemId: string): Promise<URL | null>;
     ...
     */
    getAdvancedSearchForm(): Promise<UserForm | null>;
    /**
     ...
     */
    getTags(): Promise<TagSection[] | null>;
    /**
     ...
     */
    getViewMoreItems(homepageSectionId: string, metadata: any): Promise<PagedResults | null>;
    /**
     ...
     */
    getWebsiteMangaDirectory(metadata: any): Promise<PagedResults | null>;
