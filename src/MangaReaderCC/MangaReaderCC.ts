...
const SOURCE_DOMAIN = "https://mangareader.cc"

export class MangaReaderCC extends Source {
    constructor(cheerio: CheerioAPI) {
        super(cheerio)
    }

    get version(): string { return '0.1.0' }
    get name(): string { return 'MangaReaderCC' }
    get description(): string { return 'Mangareader Fake Version' }
    get author(): string { return 'Scythe' }
